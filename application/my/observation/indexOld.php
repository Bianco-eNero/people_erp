                ...
                <div class="container">
                    ...
                    <div class="row mbr-justify-content-center">
                        ...
                        <div class="col-lg-6 mbr-col-md-6">
                            <div class="wrap">
                                <div class="ico-wrap">
                                    <span style="color:white" class="mbr-iconfont fa-microphone fas"></span>
                                </div>
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="recordObservation/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vRecordObservation; ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mbr-col-md-6">
                            <div class="wrap">
                                <div class="ico-wrap">
                                    <span style="color:white" class="mbr-iconfont fa-align-center fas"></span>
                                </div>
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="observationLog/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vObservationLog; ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
