...
if(isset($_GET['add']) || isset($_GET['duplicate']))
{
	...
	mysqli_select_db($website,$database_website);
    $Result2 = mysqli_query($website , $insertSQL1) or die(mysqli_error($website));
	}
...
if(isset($_GET['edit']))
{
	...
	// $insertSQL2 = $row_crud_case[add_statement_en];
	mysqli_select_db($website,$database_website);
    $Result4 = mysqli_query($website , $insertSQL3) or die(mysqli_error($website));
	}
		...
		<section class="employees">
			<header class="header dont_print_me">
				<nav class="sections">
					...
					<!-- EDIT HERE 1 -->
					<a href="<?php echo $server; ?>application/my/observation/index.php?case_id=91&case_filter=" >
