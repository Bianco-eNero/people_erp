...
<section class="employees">
    <header class="header">
        <nav class="sections">
            ...
            <a href="">
                <h1 style="height:100%"><?php echo $v5adamaty; ?></h1>
            </a>
            <ul>
                <?php
                    ...
                    <div class="row mbr-justify-content-center">
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo str_replace('ال', '', $vBasicBata); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vOccupationalData); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vLeaves); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vTimeControl); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vSalariesAndBenefits); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vMedicalSystem); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vTraining); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mbr-col-md-4">
                            <div class="wrap">
                                ...
                                <div class="text-wrap vcenter">
                                    <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo  str_replace('ال', '', $vPenalties); ?> </span></a></h1>
                                </div>
                            </div>
                        </div>
