...
if(isset($_GET['add']) || isset($_GET['duplicate']))
{
	...
	echo '<script type="text/javascript">
           window.location = "index.php?case_id='.$_GET['case_id'].'"
      </script>';
}
//// End Add Statement ////
	...
	<body style="height:100%">
        ...
        <section class="account">
          <ul>
			...
			<main class="main">
				<section class="control" style="background-Color:thistle ">
					...
					<section style="<?php if($_SESSION['language']=='AR') { ?>left: 0%;float:left <?php } else { ?>right: 0%;float:left  <?php } ?>;position: absolute;z-index: 1; padding-right: 20px;padding-left: 20px; ">
...
<section class="navigation" style="<?php if($_SESSION['language']=='AR') { ?>float:left ; margin-right:400px <?php } ?>">
	...
	<input type="hidden" value="<?php echo $_GET['case_id']; ?>" name="case_id">
	<input type="hidden" value="<?php echo $_GET['case_filter']; ?>" name="case_filter">
	<input type="hidden" value="<?php echo $_GET['ref']; ?>" name="ref">

							<input autofocus="autofocus" onfocus="this.select()" value="<?php if(isset($_GET['search'])) { echo $_GET['search']; }?>" class="arabic" name="search" type="text" id="search" placeholder="<?php echo $vSearch ; ?>" style="background-color:thistle" />
						</form>
						</fieldset>
  ...
  <tbody>
    <tr>
      ...
      <td class="col-sm-<?php echo $row_add['field_width']; ?>" style="padding-right: 10px; padding-left: 10px">
		...
		<input dir="ltr" value="<?php if($_GET['edit_now']=='1' || $_GET['duplicate_now']=='1' || $_GET['view_now']=='1') { if($_SESSION['language']=='AR') { echo $row_curr[$row_add['table_field_ar']]; } else { echo $row_curr[$row_add['table_field_en']]; } } ?>" <?php if($row_add['locked']=='1') { ?> disabled <?php }  ?> placeholder="<?php if($_GET['edit_now']=='1' || $_GET['duplicate_now']=='1' || $_GET['view_now']=='1') { if($_SESSION['language']=='AR') { echo $row_curr[$row_add['table_field_ar']]; } else { echo $row_curr[$row_add['table_field_en']]; } } ?>" <?php if($row_add['field_type']=='text') { ?>type="text"<?php } ?> <?php if($row_add['field_type']=='date') { ?>type="date"<?php } ?> id="name"  name="<?php echo $row_add['field_name']; ?>" style="width: 100%" class="text_hany"  <?php if($row_add['required']=='1') { ?> required <?php } ?>/>
		  <?php } ?>
		  	<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
$count++;
				...
				<table style="border-width: 0px; margin-bottom: 0px" id="datatable_tabletools" class="table table-condensed table-striped table-bordered table-hover droid-arabic-kufi display" id="employees"  <?php if($_SESSION['language']=='AR') { ?> dir="rtl" <?php } ?>>
                	...
                	<!-- //////////////////////////////////////////////// Start Header //////////////////////////////////////////////// -->
                 	<thead>
                  		<tr  class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:left" <?php } ?>>
                  ...
                  <tr>
                    <td width="1%"  class="o_data_cell"><?php echo $counter; ?></td>
					  ...
					  ?>
					  <td class="o_data_cell" dir="ltr" style="direction: ltr; text-align: left">
						<?php
					  if($_SESSION['language']=='EN')
					  	{
					  ...
					  <td style=" font-weight: 600; min-width: 90" class="dont_print_me">
						  ...
						  <a href="<?php echo $index; ?>?1=1&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&duplicate_now=1&case_id=<?php echo $case_id; ?><?php if(isset($_GET['case_filter'])) { ?>&case_filter=<?php echo $_GET['case_filter']; } ?>"><i class="fa fa-clone fa-1x" title="Duplicate"></i></a>
						  ...
						  &nbsp;
						    ...
						    <a  href="?id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&edit_now=1&case_id=<?php echo $_GET['case_id']; ?>&selected_case=<?php echo $_GET['id']; ?>&case_filter=<?php echo $_GET['case_filter'] ; ?>"><i class="fa fa-edit fa-1x"></i></a> &nbsp;

						  <a  href="<?php echo $server.''.$row_view['case_link']; ?>?case_id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>"><i class="fa fa-glasses fa-1x"></i></a>

							<?php
								if($row_view['just_link_case']<>'1') {
							?>
						   &nbsp;

						  <a  title="Table Header" href="<?php echo $server; ?>application/admin/crud/table_header/?case_id=7&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&case_filter=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>"><i class="fa fa-th-list fa-1x"></i></a>

					 &nbsp;

						  <a  title="Table Rows" href="<?php echo $server; ?>application/admin/crud/table_row/?case_id=8&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&case_filter=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>"><i class="fa fa-th fa-1x"></i></a>

				 &nbsp;

						  <a  title="Form" href="<?php echo $server; ?>application/admin/crud/form/?case_id=9&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&case_filter=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>"><i class="fa fa-book-open fa-1x"></i></a>


						   &nbsp;

						  <a  title="Tabs" href="<?php echo $server; ?>application/admin/crud/tabs/?case_id=49&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&case_filter=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>"><i class="fa fa-folder-minus fa-1x"></i></a>
						...
						<?php } ?>
						  ...
						  <a onclick="return confirm('<?php echo $vDeleteMessage; ?>');" href="<?php echo $index; ?>?1=1&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&delete_now=1&case_id=<?php echo $case_id; ?><?php if(isset($_GET['case_filter'])) { ?>&case_filter=<?php echo $_GET['case_filter']; } ?>"><i class="fa fa-trash" title="Delete"></i></a>
