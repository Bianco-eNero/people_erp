    ...
    <header class="header">
        <nav class="sections">
            ...
            <a href="<?php echo $server; ?>application/systemAdmin/" >
                <h1 style="width: 127px;height: 100%;"><?php echo $vSystemAdmin; ?></h1>
            </a>
            <ul>
				<?php/*
                                ...
                                <div role="content" style="font-weight: 100;">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <ul class="bs-glyphicons" style="padding: 10px;margin: 0">
                                            <li>
                                                <a href="company/?case_id=31&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo str_replace('ال', '', $vCompanies );?></span>
                                                </a>
                                            </li>
