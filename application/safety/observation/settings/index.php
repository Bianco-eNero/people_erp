...
<section class="employees">
    <header class="header">
        <nav class="sections">
            ...
            <a href="<?php echo $server; ?>application/safety/observation/" >
                <h1 style="width: 127px;height: 100%;"><?php echo $vObservation; ?></h1>
            </a>
            <ul>
				<?php
                                ...
                                <div role="content" style="font-weight: 100;">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <ul class="bs-glyphicons" style="padding: 10px;margin: 0">
                                            <li>
                                                <a href="categories/?case_id=95&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo str_replace('ال', '', $vCategories );?></span>
                                                </a>
                                            </li>
