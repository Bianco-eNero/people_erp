...
<section class="employees">
    <header class="header dont_print_me">
        <nav class="sections">
            ...
            <!-- EDIT HERE 1 -->
            <a href="<?php echo $server; ?>application/systemAdmin/" >
                                                ...
                                                if($_SESSION['language']=='AR')
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                if ($row_table_rows['row_field_ar']=='holding_company_id'){
                                                                    ///// View Script (Table Rows) /////
                                                                    mysqli_select_db($website,$database_website);
                                                                    $holding_company_id=$row_view[$row_table_rows['row_field_ar']];
                                                                    $holding_company = mysqli_query($website , "SELECT * FROM organization WHERE holding_company_id='$holding_company_id' ") or die(mysqli_error($website));
                                                                    $row_holding_company = mysqli_fetch_assoc($holding_company);
                                                                    ///// end View Script (Table Rows) /////
                                                                    if($_SESSION['language']=='AR')
                                                                    {
                                                                        echo $row_holding_company['organization_arabic'];
                                                                    }else{
                                                                        echo $row_holding_company['organization_english'];
                                                                    }
                                                                }else{
                                                                    ///////////////////////// if other Fields /////////////////////////////
