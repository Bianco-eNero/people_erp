...
<section class="employees">
    <header class="header">
        <nav class="sections">
            ...
            <a href="<?php echo $server; ?>application/companyAdmin/" >
                <h1 style="width: 127px;height: 100%;"><?php echo $vCompanyAdmin; ?></h1>
            </a>
            <ul>
				<?php/*
				//// include training header ////
				include('../../../assets/menus/header/')
				*/?>
            </ul>
        </nav>
                        ...
                        <article class="col-sm-12 sortable-grid ui-sortable">
                            ...
                            <div class="jarviswidget jarviswidget-color-purple jarviswidget-sortable" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" role="widget">
                                ...
                                <header role="heading"><div class="jarviswidget-ctrls" role="menu">
                                    <a style="display: none" href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn" rel="tooltip" title="" data-placement="bottom" data-original-title="Fullscreen"><i class="fa fa-expand "></i></a> </div>
                                ...
                                <div role="content" style="font-weight: 100;">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <ul class="bs-glyphicons" style="padding: 10px;margin: 0">
                                            <li>
                                                <a href="authoritiesGroups/?case_id=31&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vAuthoritiesGroups;?></span>
                                                </a>
                                            </li>
