				...
				<form  method="GET" target="_self" name="add">
					...
					<section class="employee-create">
						...
						<section class="title">
							...
							<?php } ?>
							<fieldset>
								<label for="name" style="display: none;"><?php
								if($_SESSION['language']=='AR')
								{
								...
								?></label><br />
								<input style="display: none;" name="<?php echo $row_add_1['field_name']; ?>" type="text" id="name" placeholder="<?php
								if($_SESSION['language']=='AR')
								{
								echo $row_add_1['title_ar'];
								}
							  ...
							  <input style="display: none;" value="<?php if($_GET['edit_now']=='1' || $_GET['duplicate_now']=='1' || $_GET['view_now']=='1') { if($_SESSION['language']=='AR') { echo $row_curr[$row_add_2['table_field_ar']]; } else { echo $row_curr[$row_add_2['table_field_en']]; } } ?>" name="<?php echo $row_add_2['field_name']; ?>" type="text" id="part-time" placeholder="<?php
								if($_SESSION['language']=='AR')
								{
