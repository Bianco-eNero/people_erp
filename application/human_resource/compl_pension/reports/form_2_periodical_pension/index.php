...
<div class="table-responsive_" style="border-style:groove; border-width:1px; border-color:#000000; margin:1px">
	...
	<div align="center" style="text-align:center; margin:20px">
	  <table width="100%" border="0" cellspacing="2" cellpadding="2" dir="ltr" style="direction:ltr">
        <tr>
          <td width="45%" style="text-align:left"><span class="style8 arabic" style="text-align: center;"><strong>نموذج رقم (٢)</strong></span><span class="style8"><br>
          
          مذكرة صرف المعاش الدوري</span></td>
          <td width="15%">&nbsp;</td>
...
<div align="center" style="text-align:center; margin:20px">
  ...
  <tr>
    ...
    <td width="25%"><span class="style12"><strong>تاريخ انتهاء الخدمة </strong></span></td>
  ...
  <tr>
    <td width="25%"><div align="right" class="style13">
      <div align="right" class="style12"><?php echo $_GET['end_service_type']; ?></div>
    </div></td>
    <td width="25%"><span class="style12"><strong>سبب انتهاء الخدمة  </strong></span></td>
...
?>
  ...
  <tr>
    <td colspan="4" valign="top">
      ...
      <tr>
        ...
        <td><div align="center">
          <span class="style12"><?php echo $row_Recordset1['cp_basic_salary_total_last_july'] ; ?></span>
        </div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td colspan="4" valign="top"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" style="direction:ltr">
      <tr>
        <td colspan="5"><div align="right" class="style12"><?php echo $_GET['agr_e7tesab_dof3a'] ; ?></div></td>
        <td width="25%" class="style13"><div align="right" class="style7">أجر احتساب قيمة الدفعة</div></td>
      </tr>
      <tr>
        <td width="16%"><div align="right"></div></td>
        <td width="16%" bgcolor=""><span class="style13">بتاريخ</span></td>
        <td width="10%"><div align="right"></div></td>
        <td width="11%" bgcolor=""><span class="style13">ايصال رقم</span></td>
        <td width="20%"><div align="right" class="style12"><?php echo $_GET['mandatory_period_amount']; ?></div></td>
        <td width="25%" bgcolor="" class="style13"><div align="right" class="style7">سداد قيمة المدة الحكمية</div></td>
      </tr>
      <tr>
        <td colspan="5"><div align="right"></div></td>
        <td width="25%" bgcolor="" class="style13"><div align="right" class="style7">الأجر الاجمالي الشهري الفعلي</div></td>
      </tr>
      <tr>
        <td colspan="5"><div align="right" class="style12"><?php echo $_GET['alagr_el_shahry_el_hokmy']; ?></div></td>
        <td width="25%" bgcolor="" class="style13"><div align="right" class="style7">الأجر الاجمالي الشهري الحكمي</div></td>
      </tr>
      <tr>
        <td colspan="5"><div align="right" class="style12">
       
       <?php echo $_GET['alagr_el_shahry_el_hokmy']; ?>
       - 
       <?php echo $_GET['max_of_social_salary'] ; ?> 
       =
        <?php echo $_GET['share7at_elm3ash']; ?> 
       
		
        </div></td>
        <td width="25%" bgcolor="" class="style13"><div align="right" class="style7">شريحة المعاش</div></td>
      </tr>
      <tr>
        <td colspan="5"><div align="right" class="style12" dir="rtl">
              <?php echo $_GET['acc_and_mand']; ?> 
        * 2 =
             <?php echo $_GET['mokasas_el_dof3at']; ?> 
        ...
        <td width="25%" bgcolor="" class="style13"><div align="right" class="style7">مخصص الدفعات الدورية</div></td>
      </tr>
      <tr>
        <td colspan="5">
          <div align="right" class="style12"><?php echo $_GET['el_dof3a_el_shahreya']; ?> جنيه          </div></td>
        <td width="25%" bgcolor="" class="style13"><div align="right" class="style7">الدفعة الشهرية الدورية</div></td>
      </tr>
      <tr>
        <td colspan="5"><div align="center"><span class="style7"><span class="style12"><span class="style12"><span class="style12"><span class="style7"><span class="style7"></span></span></span></span></span></span>
          <div align="right"></div>
        </div></td>
        <td width="25%" bgcolor="" class="style13"><div align="center" class="style7">
          <div align="right">تسويات سابقة حتى</div>
        </div></td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td colspan="4" valign="top"><div align="right" class="style7">وافقت اللجنة الرئيسية بلجنتها رقم ....................... بتاريخ ........ / ....... / ............. على صرف قيمة الدفعة الشهرية الدورية (المعاش) المستحقة
