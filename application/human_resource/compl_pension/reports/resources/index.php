...
$row_employee34 = mysqli_fetch_assoc($employee34);
      ...
      <tr>
        <td><?php 
					if($_SESSION['language']=='EN')
					{
					echo $row_employee3['cp_account_e']; 
					}
					if($_SESSION['language']=='AR')
					{
					echo $row_employee3['cp_account_a']; 
					}
					?></td>
        <td><?php echo number_format($row_employee34['db_diff'], 2, '.', ',');
