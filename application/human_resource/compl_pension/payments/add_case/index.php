						...
						<section class="title">
							...
							<fieldset>
							  ...
							  <select name="end_service" id="jumpMenu2" onChange="MM_jumpMenu2('parent',this,0)">
							    ...
							    <?php } while ($row_employees32 = mysql_fetch_assoc($employees32));
...
<table class="o_list_view table table-sm table-hover table-striped o_list_view_ungrouped table-responsive-sm table-condensed">
  <thead>
    ...
    <input name="company_name" value="<?php echo $row_employees2['cp_company_name_ar']; ?>" type="hidden">
    <input name="company_code" value="<?php echo $row_employees2['cp_company_code']; ?>" type="hidden">
    ...
    <input name="end_service_type" value="<?php echo $row_employees32a['cp_end_server_type_a'] ; ?>" type="hidden">
    ...
    <input name="vTotalAllowedAmount" value="<?php echo $vTotalAllowedAmount; ?>" type="hidden">
  ...
  <?php
    ...
    ///////////////////////////////////////////////
    //// end 1 TERMINATION NON-PUNITIVE REASON done /////////////////////////
    //////////////////////////////////////////////
...
$tamweel_mokasas_el_7ad= (20*$agr_e7tesab_dof3a) - $personal_balance;

//// later form Mr Mohamed Khalda will send the table of ages and any extra year adding 2 months ////
$monthsOfOnePayments='1';
///// later ////

$mokaf2et_el_dof3al_el_wa7da=$agr_e7tesab_dof3a*$monthsOfOnePayments;
...
<tr>
  ...
  <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>>
      ...
      <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>>
          ...
          <?php echo 'رصيد الحساب الشخصي للعامل'; ?></th>

    <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>>

      <?php echo 'قيمة التمويل من مخصص الحد الأدنى'; ?></th>

    <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>>

      <?php echo 'مكافأة الدفعة الواحدة'; ?></th>
...
<tbody class="ui-sortable">
  ...
  <tr class="o_data_row" >
    ...
    <td class="o_data_cell"><?php
    echo number_format($personal_balance, 2, '.', ',');
    ...
    echo number_format($tamweel_mokasas_el_7ad, 2, '.', ',');
    $tamweel_mokasas_el_7ad=$tamweel_mokasas_el_7ad;
    ?>
    </td>
       ...
       <td class="o_data_cell"><?php
    echo number_format($mokaf2et_el_dof3al_el_wa7da, 2, '.', ',');
    $mokaf2et_el_dof3al_el_wa7da=$mokaf2et_el_dof3al_el_wa7da;
    ?>
    </td>
...
<form target="_blank" method="get" action="../../../compl_pension/reports/form_3_one_payment_death_service/">
...
<input name="mokasas_el_dof3at" value="<?php echo $mokasas_el_dof3at ; ?>" type="hidden">
<input name="el_dof3a_el_shahreya" value="<?php echo $el_dof3a_el_shahreya; ?>" type="hidden">
<input name="tamweel_mokasas_el_7ad" value="<?php echo $tamweel_mokasas_el_7ad; ?>" type="hidden">
<input name="mokaf2et_el_dof3al_el_wa7da" value="<?php echo $mokaf2et_el_dof3al_el_wa7da; ?>" type="hidden">
...
<button style="margin: 10px; font-size: 16px; background-color: orange; color: white" type="submit" class="btn dont_print_me"><?php echo $vForm3CP; ?></button>
...
//// select all end type service ////
mysql_select_db($database_localhost, $localhost);
$query_employees32ee = "SELECT * FROM cp_monthly_payment_rate WHERE '$share7at_elm3ash'>=avg_slr_from AND '$share7at_elm3ash'< avg_slr_to_less_than ORDER BY avg_slr_from";
...
<form target="_blank" method="get" action="../../../compl_pension/reports/form_2_periodical_pension/">
...
?>
              ...
              <form target="_blank" method="get" action="../../../compl_pension/reports/form_5_quit_cp_system/">
              ...
              <button style="margin: 10px; font-size: 16px; background-color: orange; color: white" type="submit" class="btn dont_print_me"><?php echo $vForm5CP; ?></button>
