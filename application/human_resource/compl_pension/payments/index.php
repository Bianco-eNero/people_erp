			...
			<main class="main" style="height:100%">
				<section class="control">
					<section class="action">
						<h1><a href=""><span class="root"><?php echo $vPayments; ?> </span></a></h1>
										...
										<div class="container">
												...
												<div class="row mbr-justify-content-center">
										            ...
										            <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-calendar-plus fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
										                        <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="add_case/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vAddCase ; ?> </span></a></h1>
