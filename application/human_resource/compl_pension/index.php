...
mysqli_select_db($website,$database_website );
$query_Recordset2 = "SELECT COUNT(cp_installment_period_id) AS TOTAL_PERIODS FROM cp_installment_period WHERE cp_installment_period_closed=1";
			...
			<header class="header">
				<nav class="sections">
					...
					<a href="<?php echo $server; ?>application/human_resource/compl_pension/" >
						<h1 style="height: 100%;"><?php echo str_replace('ال', '', $vComplementaryPension); ?></h1>
					</a>
						<ul>
							<?php
												...
												<div class="row mbr-justify-content-center">
										            ...
										            <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    ...
										                    <div class="text-wrap vcenter">
										                        <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="members/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo str_replace('ال', '', $vMembers ); ?> (<?php echo $row_Recordset1['TOTAL_MEMBERS'];?>)</span></a></h1>
										            ...
										            <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    ...
										                    <div class="text-wrap vcenter">
                                                                <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="saving_installments/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo str_replace('ال', '', $vSavingInstallments ); ?> (<?php echo $row_Recordset2['TOTAL_PERIODS'];?>)</span></a></h1>
										                    </div>
										                </div>
										            </div>
													 ...
													 <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    ...
										                    <div class="text-wrap vcenter">
                                                                <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="bank_deposits/?case_id=74&case_filter=&ref=" style="color:white"><span class="arabic" style="font-size:20px"><?php echo str_replace('ال', '', $vInvReturn ) ; ?> </span></a></h1>
										                    </div>
										                </div>
										            </div>
