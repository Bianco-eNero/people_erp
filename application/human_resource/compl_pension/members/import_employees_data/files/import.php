...
$query = "LOAD DATA LOCAL INFILE '$targetFile2' INTO TABLE employee FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (employee_id, name_arabic, birth_date, national_id_card_no, company_join_date, sector_join_date, cp_number, cp_company_code, cp_member_start_date) SET organization  = $current_company, patch_code=$patch_code";
...
<div class="row">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="alert-message alert-message-success arabic">
				...
				<meta http-equiv="refresh" content="2; url=<?php echo $server; ?>application/human_resource/compl_pension/members/" />
