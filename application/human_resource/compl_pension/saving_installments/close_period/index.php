...
<?php
	...
	$closing_balance=$row_Recordset1['start_banace_le']+$row_Recordset1['emp_portion_le']+$row_Recordset1['inv_emp_portion_le']+$row_Recordset1['co_portion_le']+$row_Recordset1['inv_co_portion_le'];
				...
				if(isset($_GET['close']) && $_GET['close']=='1') {
					...
					$emp=$row_Recordset1['employee_id'];
					
mysqli_select_db($website,$database_website );
$query_Recordset344 = "UPDATE employee SET cp_last_open_balance_le='$closing_balance'  WHERE employee_id='$emp'";
...
mysqli_select_db($website,$database_website );
$query_Recordset344c = "UPDATE cp_transaction SET end_balance_le='$closing_balance'  WHERE employee_id='$emp'";
$Recordset344c = $website->query($query_Recordset344c);
...
?>
            <?php } while ($row_Recordset1 = mysqli_fetch_assoc($Recordset1)); 
				...
				if(isset($_GET['close']) && $_GET['close']=='1') {
					...
					$ids=$row_Recordset2['cp_installment_period_id'];
					
mysqli_select_db($website,$database_website );
$query_Recordset34422 = "UPDATE cp_installment_period SET cp_installment_period_closed ='1'  WHERE cp_installment_period_id='$ids'";
$Recordset34422 = $website->query($query_Recordset34422);
