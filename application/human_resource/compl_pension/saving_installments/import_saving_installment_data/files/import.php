...
$query = "LOAD DATA LOCAL INFILE '$targetFile2' INTO TABLE cp_transaction FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (age_on_date, employee_id, emp_basic_le, excluded_incentive_le, production_incentive_le, emp_portion_le, co_portion_le, egpc_portion_le) SET patch_code=$patch_code, cp_installment_period_id=$current_period";
...
<div class="row">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="alert-message alert-message-success arabic">
				...
				<meta http-equiv="refresh" content="2; url=<?php echo $server; ?>application/human_resource/compl_pension/saving_installments/" />
