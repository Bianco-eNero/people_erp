...
<button id="filters"><i class="fas fa-filter"></i>Filters<i class="fas fa-caret-down"></i></button>
				...
				<!-- Start of Content -->
					...
					<div class="row mbr-justify-content-center">
										            ...
										            <div class="col-lg-4 mbr-col-md-3">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-beer fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
										                        <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="journal/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vJournal ; ?> </span></a></h1>
										            ...
										            <div class="col-lg-4 mbr-col-md-3">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-book fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
																					<h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="ledger/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vCpLedger ; ?> </span></a></h1>
													 ...
													 <div class="col-lg-4 mbr-col-md-3">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-balance-scale fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
																					<h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="trial_balance/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vCpTrialBalance ; ?> </span></a></h1>
							 ...
							 <div class="col-lg-6 mbr-col-md-3">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-bookmark fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
																					<h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="resources/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vCpUsesAndResources ; ?> </span></a></h1>
						 ...
						 <div class="col-lg-6 mbr-col-md-3">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-binoculars fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
																					<h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="balance_sheet/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vCpBalanceSheet ; ?> </span></a></h1>
