...
<html lang="en">
	...
	<body style="height:100%">
		<section class="employees">
			<header class="header" <?php if($this_is_pop=='1') { ?> style="display: none" <?php } ?>>
				<nav class="sections">
  ...
  <tbody>
    <tr>
      ...
      <td class="col-sm-<?php echo $row_add['title_width']; ?>" style="padding-right: 10px; padding-left: 10px"><?php
				...
				?></td>
      <td class="col-sm-<?php echo $row_add['field_width']; ?>" style="padding-right: 10px; padding-left: 10px ; <?php  if($_GET['view_now']=='1')
		  { ?> border-bottom-color: silver;
    border-bottom-style: solid;
    border-width: 1px; <?php } ?>">
		  ...
		  if($_GET['view_now']=='1')
		  {
			  ...
			  if($_SESSION['language']=='AR') { echo '<b>'.$row_curr[$row_add['table_field_ar']].'</b>'; } else { echo '<b>'.$row_curr[$row_add['table_field_en']].'</b>'; }
		  }
			else
			{
		   //// end of the view case ////

			  ?>

		<input value="<?php if($_GET['edit_now']=='1' || $_GET['duplicate_now']=='1') { if($_SESSION['language']=='AR') { echo $row_curr[$row_add['table_field_ar']]; } else { echo $row_curr[$row_add['table_field_en']]; } } ?>" <?php if($row_add['locked']=='1') { ?> disabled <?php }  ?> placeholder="<?php if($_GET['edit_now']=='1' || $_GET['duplicate_now']=='1' || $_GET['view_now']=='1') { if($_SESSION['language']=='AR') { echo $row_curr[$row_add['table_field_ar']]; } else { echo $row_curr[$row_add['table_field_en']]; } } ?>" <?php if($row_add['field_type']=='text') { ?>type="text"<?php } ?> <?php if($row_add['field_type']=='date') { ?>type="date"<?php } ?> id="name"  name="<?php echo $row_add['field_name']; ?>" style="width: 100%" class="text_hany"  <?php if($row_add['required']=='1') { ?> required <?php } ?>/>
		  ...
		  <?php } }  ?>
			...
			<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
				...
				<select style="width:100%; height:30px; <?php  if($_GET['view_now']=='1')
		  { ?> border-style: none;
    background-color: white; <?php } ?>" class="select2 select2-hidden-accessible droid-arabic-kufi col-md-6" tabindex="-1" aria-hidden="true" name="<?php echo $row_add['field_name']; ?>">
				...
				<div>
				<textarea class="droid-arabic-kufi" id="summernote" name="<?php echo $row_add['field_name']; ?>" <?php if(!isset($_GET['view_now'])) { ?>cols="100%" rows="4" <?php } else { ?> cols="100%" rows="4" <?php  } ?>><?php
                    ...
                    <td width="1%"  class="o_data_cell"><?php echo $counter; ?></td>
					  ...
					  <td style=" font-weight: 600; min-width: 90" class="dont_print_me">
						...
						<a href="?id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&edit_now=1&case_id=<?php echo $_GET['case_id']; ?>&selected_case=<?php echo $_GET['id']; ?>&case_filter=<?php echo $_GET['case_filter'] ; ?>">
						  ...
						  <a onclick="return confirm('<?php echo $vDeleteMessage; ?>');" href="?id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&delete_now=1&case_id=<?php echo $_GET['case_id']; ?>&case_filter=<?php echo $_GET['case_filter'] ; ?>">
							  <i class="fa fa-trash"></i>
						  </a>

&nbsp; &nbsp;
							<a href="../../../../application/human_resource/reports/medical_management/medical_record/?id=<?php echo $row_Recordset1['emp_id']; ?>&report=1" target="_blank">
															 <i class="fas fa-file" title="<?php echo $vMedicalRecords; ?>"></i>
														 </a>
						  ...
						  <?php
					  	  ...
					  	  ?>
						   &nbsp;
						  <a   href="<?php echo $index; ?>?1=1&id=<?php echo $row_view[$row_table_rows_id['row_field_ar']]; ?>&case_id=<?php echo $case_id; ?>&has_sub_case=1<?php if(isset($_GET['case_filter'])) { ?>&case_filter=<?php echo $_GET['case_filter']; } ?>&ref=<?php
