...
بيان المستفيدين من العلاج الاسرى
    </p>
	  <p class="style1 arabic" style="text-align: center;">
	  <span style="font-size:12px">

		  <strong><?php echo $vName;?>:&nbsp;</strong>محمد احمد محمد <br />
		  <strong><?php echo $vEmployeeNumber;?>:&nbsp;</strong>3244
...
<table class="o_list_view table table-sm table-hover table-striped o_list_view_ungrouped table-responsive-sm" style="font-size:10px">
  <thead>
    <tr>
      ...
      <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vBen; ?></th>
      <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vName; ?></th>
      <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vRelativeRelation; ?></th>
                ...
                <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vProductionIncentive; ?></th>
                  ...
                  <?php } ?>
                    <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vSocialStatus; ?></th>
                      <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vEmployer; ?></th>
                    <th class="o_column_sortable" <?php if($_SESSION['language']=='AR') { ?>style="text-align:right" <?php } ?>><?php echo $vNotes; ?></th>
