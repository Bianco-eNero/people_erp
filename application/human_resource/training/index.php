		...
		<section class="employees">
			<header class="header">
				<nav class="sections">
					...
					<a href="<?php echo $server; ?>application/human_resource/training/" >
						<h1 style="height: 100%;"><?php echo str_replace('ال', '', $vTraining);?></h1>
					</a>
						<ul>
							<?php
							//// include training header ////
							include('../../../assets/menus/header/training.php')
							?>
						</ul>
				</nav>
