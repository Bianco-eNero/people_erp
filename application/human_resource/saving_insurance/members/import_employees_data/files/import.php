...
$query = "LOAD DATA LOCAL INFILE '$targetFile2' INTO TABLE employee FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (employee_id, name_arabic, birth_date, national_id_card_no, company_join_date, sector_join_date, sp_number, sp_company_code, sp_member_start_date) SET organization  = $current_company, patch_code=$patch_code";
