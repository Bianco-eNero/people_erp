...
$query_Recordset1 = "SELECT * FROM employee WHERE organization='$organization' AND employee_id LIKE '%$search%' AND organization='$cooo' ORDER BY employee_id";
					...
					<section class="action">
						<h1><span class="root"><?php echo $vMembers; ?></span></h1>
							...
							<fieldset>
								...
								<a class="focus" href="update_salary_data/" style="text-decoration:none; display: none"><input type="submit" name="create" id="create" value="<?php echo $vUpdateTheSalary; ?>" class="focus" /></a>
...
<button id="filters"><i class="fas fa-filter"></i>Filters<i class="fas fa-caret-down"></i></button>
						...
						<fieldset class="view">
							 ...
							 <span class="print">
								<a href="<?php echo $server; ?>application/human_resource/saving_insurance/reports/members/?report=1" target="_blank" >
        ...
        <tr class="o_data_row" >
          ...
          <td class="o_data_cell"><?php
					...
					<td class="o_data_cell">
                        ...
                        <a href="../../../../application/human_resource/personnel/employees/employee/?funds=2&id=<?php echo $row_Recordset1['employee_id']; ?>" target="_blank">
