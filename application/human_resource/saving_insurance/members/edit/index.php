...
$status_1all = mysql_query($query_status_1all, $localhost) or die(mysql_error());
$row_status_1all = mysql_fetch_assoc($status_1all);

mysql_select_db($database_localhost, $localhost);
$query_status_1 = "SELECT employee_id FROM employee WHERE employee_id>'$id' ORDER BY employee_id";
$status_1 = mysql_query($query_status_1, $localhost) or die(mysql_error());
$row_status_1 = mysql_fetch_assoc($status_1);

mysql_select_db($database_localhost, $localhost);
$query_status_2 = "SELECT employee_id FROM employee WHERE employee_id<'$id' ORDER BY employee_id DESC";
$status_2 = mysql_query($query_status_2, $localhost) or die(mysql_error());
$row_status_2 = mysql_fetch_assoc($status_2);


mysql_select_db($database_localhost, $localhost);
$query_status = "SELECT * FROM sp_member_type ORDER BY sp_member_type.sp_member_type_a";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $UpdateQuery->bindColumn("sp_member_type_id", "i", "".((isset($_POST["member_type"]))?$_POST["member_type"]:"")  ."", "WA_DEFAULT");
  $UpdateQuery->bindColumn("sp_number", "s", "".((isset($_POST["member_code"]))?$_POST["member_code"]:"")  ."", "WA_DEFAULT");
  $UpdateQuery->bindColumn("sp_company_code", "s", "".((isset($_POST["company_code"]))?$_POST["company_code"]:"")  ."", "WA_DEFAULT");
  $UpdateQuery->bindColumn("sp_basic_salary_total_last_july", "s", "".((isset($_POST["basic_salary"]))?$_POST["basic_salary"]:"")  ."", "WA_DEFAULT");


      $UpdateQuery->bindColumn("sp_transferred_balance_emp_portion_le", "s", "".((isset($_POST["vTransferredPersonalPortion"]))?$_POST["vTransferredPersonalPortion"]:"")  ."", "WA_DEFAULT");
    
  $UpdateQuery->bindColumn("sp_transferred_balance_emp_portion_inv_le", "s", "".((isset($_POST["vTransferredPersonalPortionInv"]))?$_POST["vTransferredPersonalPortionInv"]:"")  ."", "WA_DEFAULT");
    
  $UpdateQuery->bindColumn("sp_transferred_balance_co_portion_le", "s", "".((isset($_POST["vTransferredCompanyPortion"]))?$_POST["vTransferredCompanyPortion"]:"")  ."", "WA_DEFAULT");
    
  $UpdateQuery->bindColumn("sp_transferred_balance_co_portion_inv_le", "s", "".((isset($_POST["vTransferredCompanyPortionInv"]))?$_POST["vTransferredCompanyPortionInv"]:"")  ."", "WA_DEFAULT");
    
    $UpdateQuery->bindColumn("sp_transferred_from", "s", "".((isset($_POST["vTransferredFrom"]))?$_POST["vTransferredFrom"]:"")  ."", "WA_DEFAULT");

    
    
$UpdateQuery->bindColumn("sp_total_monthly_salary_actual_le", "s", "".((isset($_POST["sp_total_monthly_salary_actual_le"]))?$_POST["sp_total_monthly_salary_actual_le"]:"")  ."", "WA_DEFAULT");
  $UpdateQuery->bindColumn("sp_mandatoryPeriodLeReciept", "s", "".((isset($_POST["sp_mandatoryPeriodLeReciept"]))?$_POST["sp_mandatoryPeriodLeReciept"]:"")  ."", "WA_DEFAULT");
  $UpdateQuery->bindColumn("sp_mandatoryPeriodLeDate", "s", "".((isset($_POST["sp_mandatoryPeriodLeDate"]))?$_POST["sp_mandatoryPeriodLeDate"]:"")  ."", "WA_DEFAULT");
...
<button id="filters"><i class="fas fa-filter"></i>Filters<i class="fas fa-caret-down"></i></button>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><input type="text" id="work-address2" value="<?php echo($Recordset1->getColumnVal("sp_number")); ?>" name="member_code" style="width: 90%" class="text_hany" /></td>

      <td><?php echo $vCompanyCode ; ?></td>
      <td><input name="company_code" type="text" class="text_hany" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_company_code")); ?>"></td>
  ...
  <tbody>
    <tr>
      ...
      <td width="30%"><input name="basic_salary" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_basic_salary_total_last_july")); ?>" /></td>
...
do {
?>
        <option value="<?php echo $row_status['sp_member_type_id']?>"<?php if (!(strcmp($row_status['sp_member_type_id'], ($Recordset1->getColumnVal("sp_member_type_id"))))) {echo "selected=\"selected\"";} ?>><?php echo $row_status['sp_member_type_a']?></option>
        <?php
...
?>
    ...
    <tr>
      ...
      <td width="30%"><input name="sp_total_monthly_salary_actual_le" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_total_monthly_salary_actual_le")); ?>" /></td>

	  <td width="20%"><?php echo $vcp_mandatoryPeriodLeReciept; ?></td>
    <td width="30%"><input name="sp_mandatoryPeriodLeReciept" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_mandatoryPeriodLeReciept")); ?>" /></td>
    ...
    <tr>
      ...
      <td width="30%"><input name="sp_mandatoryPeriodLeDate" type="date" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_mandatoryPeriodLeDate")); ?>" /></td>
      ...
      <td width="30%"><input name="vTransferredPersonalPortion" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_transferred_balance_emp_portion_le")); ?>" /></td>

	  <td width="20%"><?php echo $vTransferredPersonalPortionInv ; ?></td>
      <td width="30%"><input name="vTransferredPersonalPortionInv" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_transferred_balance_emp_portion_inv_le")); ?>" /></td>
      ...
      <td width="30%"><input name="vTransferredCompanyPortion" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_transferred_balance_co_portion_le")); ?>" /></td>

	  <td width="20%"><?php echo $vTransferredCompanyPortionInv ; ?></td>
      <td width="30%"><input name="vTransferredCompanyPortionInv" type="text" class="text_hany" id="" style="width: 90%" value="<?php echo($Recordset1->getColumnVal("sp_transferred_balance_co_portion_inv_le")); ?>" /></td>
