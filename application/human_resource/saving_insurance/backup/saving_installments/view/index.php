...
<section class="navigation" style="<?php if($_SESSION['language']=='AR') { ?>float:left ; margin-right:400px <?php } ?>">
    ...
    <?php } while ($row_Recordset3 = mysqli_fetch_assoc($Recordset3)); ?>
						...
						<fieldset class="view">
							 ...
							 <span class="print">
								<a href="<?php echo $server; ?>application/human_resource/saving_insurance/reports/saving_installment/?report=1&id=<?php echo $row_Recordset2['cp_installment_period_id']; ?>" target="_blank" >
