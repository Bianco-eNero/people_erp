										            ...
										            <div class="col-lg-6 mbr-col-md-10">
													 ...
													 <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    ...
										                    <div class="text-wrap vcenter">
																					<h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="bank_deposits/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vCpPayment ; ?> </span></a></h1>
