...
$query_Recordset1 = "SELECT * FROM employee WHERE (cp_member_type_id=2 || cp_member_type_id=6) AND organization='$organization' AND (cp_transaction.emp_portion_le+cp_transaction.inv_emp_portion_le+cp_transaction.co_portion_le+cp_transaction.inv_co_portion_le+cp_transaction.inv_total_le)>0";
