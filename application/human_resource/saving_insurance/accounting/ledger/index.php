...
$vDate2=date('Y-m-d', strtotime($date_new2));
  ...
  $insertSQL = sprintf("INSERT INTO sp_journal (sp_journal_id, sp_journal_code, sp_journal_date, sp_journal_desc) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_localhost, $localhost);
$query_saving_installment5 = "SELECT * FROM sp_account ";
$saving_installment5 = mysql_query($query_saving_installment5, $localhost) or die(mysql_error());
$row_saving_installment5 = mysql_fetch_assoc($saving_installment5);
$totalRows_saving_installment5 = mysql_num_rows($saving_installment5);
?>
...
<div class="col-lg-8 col-md-offset-2 well bs-component" style="margin-top:0px">
          ...
          <h3 class="droidFontRegular"><i class="fa fa-book fa-1x"></i> <?php echo $vPrint.' '.$vCpLedger; ?></h3>
          
            <div class=" bs-component">
              <form target="_blank"  action="../../../../../application/human_resource/compl_pension/reports/ledger/" onSubmit="target_popup(this)" method="GET" name="form1" class="form-horizontal" id="form1" >
              <fieldset>
                ...
                <input name="report" type="hidden" value="1">
                  ...
                  <div class="form-group" >
                    ...
                    <label for="inputEmail" class=" control-label"><B><?php echo   $vFrom; ?> </B></label>
				...
				$todaydate = date('d-m-Y', strtotime(date("Y-01-01")));
				////
				$dodo= $todaydate; 
				if (isset($_REQUEST['textEnDate'])) 
				{ 
				echo $_REQUEST['textEnDate']; 
				} 
				else 
				{ 
				echo $dodo; 
                ...
                <div class="form-group" >
                    ...
                    <label for="inputEmail" class=" control-label"><B><?php echo   $vTo; ?> </B></label>
                    
                      <input <?php echo $form_text; ?> class="form-control masked form_texty" data-format="99/99/9999" data-placeholder="_" placeholder="dd/mm/yyyy" type="text" name="vTo" id="date2"  value="<?php 
				//// convert inserted date to yyyy-mm-dd format ////
                   ...
                   <div class="form-group" >
                    ...
                    <label for="inputEmail" class=" control-label"><B><?php echo $vAccountName; ?></B></label>
                      <select <?php echo $form_text; ?>  class="form-control" name="account">
						...
						?>
                        <option value="<?php echo $row_saving_installment5['sp_account_id']; ?>" ><?php
                        if($_SESSION['language']=='EN')
						{
						echo $row_saving_installment5['sp_account_e'];
						}
						 if($_SESSION['language']=='AR')
						{
						echo $row_saving_installment5['sp_account_a'];
						}
						?></option>
                        
                        <?php
						} while ($row_saving_installment5 = mysql_fetch_assoc($saving_installment5));
						?>
