...
<div class="col-lg-8 col-md-offset-2 well bs-component" style="margin-top:0px">
          ...
          <h3 class="droidFontRegular"><i class="fa fa-book fa-1x"></i> <?php echo $vPrint.' '.$vCpBalanceSheet; ?></h3>
          
            <div class=" bs-component">
              <form target="_blank" action="../../../../../application/human_resource/compl_pension/reports/balance_sheet/" onSubmit="target_popup(this)" method="GET" name="form1" class="form-horizontal" id="form1" >
              <fieldset>
