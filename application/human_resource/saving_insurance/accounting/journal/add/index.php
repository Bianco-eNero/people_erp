...
<div class="col-lg-8 col-md-offset-2 well bs-component" style="margin-top:0px">
          ...
          <h3 class="droidFontRegular"><i class="fa fa-book fa-1x"></i> <?php echo $vAdd.' '.$vCpJournals; ?></h3>
            ...
            <div class=" bs-component">
              <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" class="form-horizontal" id="form1" >
              <fieldset>
                  ...
                  <div class="form-group" >
                    ...
                    <label for="inputEmail" class=" control-label"><B><?php echo   $vDate; ?> </B></label>
                      ...
                      <input <?php echo $form_text; ?> class="form-control masked form_texty" data-format="99/99/9999" data-placeholder="_" placeholder="dd/mm/yyyy" type="text" name="vDate" id="date1" value="<?php 
...
////
                ...
                <div class="form-group" >
                    ...
                    <label for="inputEmail" class=" control-label "><B>#</B></label>
                      ...
                      <input <?php echo $form_text; ?> class="form-control form_texty"   type="text" name="vCode" >
                   ...
                   <div class="form-group" >
                    ...
                    <label for="inputEmail" class=" control-label "><B><?php echo $vDescription; ?></B></label>
                      ...
                      <input <?php echo $form_text; ?> class="form-control form_texty"   type="text" name="vDesc" >
