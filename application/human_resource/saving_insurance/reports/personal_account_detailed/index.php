...
?>
  ...
  <tr>
        ...
        <h4 style="direction: rtl; text-align: right">رصيد منقول من شركات أخرى ( <?php echo $row_Recordset1['sp_transferred_from']; ?>  )</h4>
...
$pi=$row_Recordset1['employee_id'];
    ...
    mysqli_select_db($website,$database_website );
    $query_emp_career = "SELECT * FROM sp_transaction, sp_installment_period  WHERE sp_installment_period.sp_installment_period_id=sp_transaction.sp_installment_period_id AND (sp_transaction.emp_portion_le+sp_transaction.co_portion_le) >'0' AND sp_transaction.employee_id='$pi' ORDER BY sp_installment_period.sp_installment_period_id";
      ...
      <tr>
        <td width="80"><div align="right" class="style87" dir="rtl">
          <div align="right" style="background-color: #CBC9C9">
            <?php  echo number_format($row_Recordset1['sp_transferred_balance_emp_portion_le']+$row_Recordset1['sp_transferred_balance_emp_portion_inv_le']+$row_Recordset1['sp_transferred_balance_co_portion_le']+$row_Recordset1['sp_transferred_balance_co_portion_inv_le'], 2, '.', ',');
              
              $total_transferred_balance=$row_Recordset1['sp_transferred_balance_emp_portion_le']+$row_Recordset1['sp_transferred_balance_emp_portion_inv_le']+$row_Recordset1['sp_transferred_balance_co_portion_le']+$row_Recordset1['sp_transferred_balance_co_portion_inv_le'];
              ?>
            </div>
        </div></td>
        <td width="80"><div align="right" class="style87" dir="rtl">
          <div align="right">
            <?php  echo number_format($row_Recordset1['sp_transferred_balance_co_portion_inv_le'], 2, '.', ','); ?>
          </div>
        </div></td>
        <td width="80"><div align="right" class="style87" dir="rtl">
          <div align="right">
            <?php  echo number_format($row_Recordset1['sp_transferred_balance_co_portion_le'], 2, '.', ','); ?>
            </div>
        </div></td>
        <td width="80"><div align="right" class="style87" dir="rtl">
          <div align="right">
            <?php  echo number_format($row_Recordset1['sp_transferred_balance_emp_portion_inv_le'], 2, '.', ','); ?>
            </div>
        </div></td>
        <td width="80"><div align="right" class="style87" dir="rtl">
          <div align="right">
            <?php  echo number_format($row_Recordset1['sp_transferred_balance_emp_portion_le'], 2, '.', ','); ?>
            </div>
        </div></td>
        </tr>
    </table>
...
?></div></td>
        <td width="200"><div dir="rtl" align="right" class="style73"><span class="style5"><?php echo $row_emp_career['sp_installment_period_desc']; ?></span></div></td>
      </tr>
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="3" dir="rtl">
        <tbody>
          ...
          <tr>
            <td width="30%">&nbsp;</td>
            <td>&nbsp;</td>
            <td width="30%"><div align="center" style="text-align: center; border-top-color:#000000; border-top-style:solid; border-top-width:1px; font-size: 20px"><strong>
