...
$query_employee344 = "SELECT *, SUM(sp_journal_transaction.sp_db) AS db_total, SUM(sp_journal_transaction.sp_cr) AS cr_total, if((SUM(sp_journal_transaction.sp_db)>SUM(sp_journal_transaction.sp_cr)),(SUM(sp_journal_transaction.sp_db)-SUM(sp_journal_transaction.sp_cr)),0) AS db_diff, if((SUM(sp_journal_transaction.sp_cr)>SUM(sp_journal_transaction.sp_db)),(SUM(sp_journal_transaction.sp_cr)-SUM(sp_journal_transaction.sp_db)),0) AS cr_diff FROM sp_journal_transaction, sp_journal WHERE sp_journal.sp_journal_id=sp_journal_transaction.sp_journal_id AND  sp_journal_transaction.sp_account_id='3' AND sp_journal.sp_journal_date<='$from' GROUP BY sp_journal_transaction.sp_account_id";
...
$query_employee3447 = "SELECT *, SUM(sp_journal_transaction.sp_db) AS db_total, SUM(sp_journal_transaction.sp_cr) AS cr_total, if((SUM(sp_journal_transaction.sp_db)>SUM(sp_journal_transaction.sp_cr)),(SUM(sp_journal_transaction.sp_db)-SUM(sp_journal_transaction.sp_cr)),0) AS db_diff, if((SUM(sp_journal_transaction.sp_cr)>SUM(sp_journal_transaction.sp_db)),(SUM(sp_journal_transaction.sp_cr)-SUM(sp_journal_transaction.sp_db)),0) AS cr_diff FROM sp_journal_transaction, sp_journal WHERE sp_journal.sp_journal_id=sp_journal_transaction.sp_journal_id AND  sp_journal_transaction.sp_account_id='7' AND sp_journal.sp_journal_date<='$from' GROUP BY sp_journal_transaction.sp_account_id";
...
$query_employee34474 = "SELECT *, SUM(sp_journal_transaction.sp_db) AS db_total, SUM(sp_journal_transaction.sp_cr) AS cr_total, if((SUM(sp_journal_transaction.sp_db)>SUM(sp_journal_transaction.sp_cr)),(SUM(sp_journal_transaction.sp_db)-SUM(sp_journal_transaction.sp_cr)),0) AS db_diff, if((SUM(sp_journal_transaction.sp_cr)>SUM(sp_journal_transaction.sp_db)),(SUM(sp_journal_transaction.sp_cr)-SUM(sp_journal_transaction.sp_db)),0) AS cr_diff FROM sp_journal_transaction, sp_journal WHERE sp_journal.sp_journal_id=sp_journal_transaction.sp_journal_id AND  sp_journal_transaction.sp_account_id='4' AND sp_journal.sp_journal_date<='$from' GROUP BY sp_journal_transaction.sp_account_id";
