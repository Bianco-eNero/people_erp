...
$query_Recordset1 = "SELECT * FROM sp_installment_period WHERE sp_installment_period_desc LIKE '%$search%' ORDER BY sp_installment_period_id DESC";
    ...
    <thead>
      <tr>
        ...
        <tr class="o_data_row">
          ...
          <td class="o_data_cell"><?php echo $row_Recordset1['sp_installment_period_desc']; ?></td>
          <td class="o_data_cell" style="color: white; <?php
				 if($row_Recordset1['sp_installment_period_closed']=='1') { ?>background-color: red <?php } else { ?>background-color: green<?php } ?>">
			<?php
				 if($row_Recordset1['sp_installment_period_closed']=='1') { echo $vClosedPeriod ; } else { echo $vOpenPeriod;  }
			?>
			</td>
					<td class="o_data_cell"><form name="form" id="form">

						<a href="view/?id=<?php echo $row_Recordset1['sp_installment_period_id']; ?>&closed=<?php echo $row_Recordset1['sp_installment_period_closed']; ?>">
