...
mysqli_select_db($website,$database_website );
$query_Recordset344 = "UPDATE employee SET sp_last_open_balance_le='$closing_balance'  WHERE employee_id='$emp'";
...
mysqli_select_db($website,$database_website );
$query_Recordset344c = "UPDATE sp_transaction SET end_balance_le='$closing_balance'  WHERE employee_id='$emp'";
...
?>
            <?php } while ($row_Recordset1 = mysqli_fetch_assoc($Recordset1)); 
				...
				if(isset($_GET['close']) && $_GET['close']=='1') {
					...
					$ids=$row_Recordset2['sp_installment_period_id'];
					
mysqli_select_db($website,$database_website );
$query_Recordset34422 = "UPDATE sp_installment_period SET sp_installment_period_closed ='1'  WHERE sp_installment_period_id='$ids'";
