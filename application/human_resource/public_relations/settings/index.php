...
<section class="employees">
    <header class="header">
        <nav class="sections">
            ...
            <a href="<?php echo $server; ?>application/human_resource/public_relations/" >
                <h1 style="height: 100%;width: 135px;"><?php echo $vPublicRelations; ?></h1>
            </a>
            <ul>
				<?php
				//// include training header ////
				include('../../../../assets/menus/header/public_relations.php')
				?>
            </ul>
        </nav>
