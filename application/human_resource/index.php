				...
				<section class="body" style="height:100%">
					...
					<div class="row mbr-justify-content-center">
										            ...
										            <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    ...
										                    <div class="text-wrap vcenter">
										                        <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="compl_pension/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vComPen ; ?> </span></a></h1>
						                            ...
						                            <div class="col-lg-6 mbr-col-md-10">
										                <div class="wrap">
										                    <div class="ico-wrap">
										                        <span style="color:white" class="mbr-iconfont fa-leaf fa"></span>
										                    </div>
										                    <div class="text-wrap vcenter">
										                        <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="../human_resource/saving_insurance/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vSavingInsurance ; ?> </span></a></h1>
