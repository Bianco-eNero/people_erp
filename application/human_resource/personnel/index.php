			...
			<main class="main" style="height:100%">
				<section class="control">
					<section class="action">
						<h1><?php echo str_replace('ال', '', $vEmployees); ?></h1>
                                ...
                                <div class="col-lg-4 mbr-col-md-6">
                                    <div class="wrap">
                                        ...
                                        <div class="text-wrap vcenter">
                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="employees/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo str_replace('ال', '', $vEmployees); ?> </span></a></h1>
                                        </div>
                                    </div>
                                </div>
