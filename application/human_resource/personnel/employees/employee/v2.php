...
<head>
    ...
    <style>
        *{font-weight: 100}
        ...
        .tab-pane{ background: #efefef; border-radius: 25px; }
        .tab-color { background: #fff;border: 1px solid #e2e2e2;border-radius: 25px;padding: 5px 10px; }
        ...
        <section class="control">
            <section class="action">
                <h1><span class="root"><ol class="breadcrumb" style="background: none">
                        <li><a href="<?php echo $server; ?>application/human_resource/personnel"><?php echo str_replace('ال', '', $vEmployees ); ?></a></li>
                    ...
                    <div id="content" >
                        ...
                        <div class="widget-body">
                            <div class="row padding-10">
                                ...
                                <div class="col-md-6" style="padding: 10px;<?php if($_SESSION['language']=='AR') { echo 'float:right;'; }?>">
                                    <h1 ><?php if($_SESSION['language']=='AR') { echo $row_Recordset1['name_arabic']; }else{ echo $row_Recordset1['name_english']; } ?></h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 tab-content">
                                    ...
                                    <div class="padding-10 tab-pane active"  id="tab-basic">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vPersonalData2;?></h5>
                                        <div class="tab-color">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-familymember">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vFamilymember;?></h5>
                                        <div class="tab-color">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-military">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vMilitaryStatus;?></h5>
                                        <div class="tab-color">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-educational">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vEducationalCertificates;?></h5>
                                        <div class="tab-color">
                                            <div class="table-responsive">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-visa">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vVisasAndWorPerms;?></h5>
                                        <div class="tab-color">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-occupational">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vJobOccupyingTypes;?></h5>
                                        <div class="tab-color">
                                    ...
                                    <div class=" padding-10 tab-pane" id="tab-CareerDevelopmentData">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vInternalJobs;?></h5>
                                        <div class="tab-color">
                                            <div class="table-responsive">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-endingServing">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vEndingService;?></h5>
                                        <div class="tab-color">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-leaves">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vLeavesValidBalances;?></h5>
                                        <div class="tab-color">
                                            <div class="table-responsive">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-leavesInvalid">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vLeavesInvalidBalances;?></h5>
                                        <div class="tab-color">
                                            <div class="table-responsive">
                                    ...
                                    <div class="padding-10 tab-pane" id="tab-timeControl">
                                        <h5 class="filled-title padding-5" style="text-align: center;"><?php echo $vTimeControl;?></h5>
                                        <div class="tab-color">
                                            <div class="table-responsive">
