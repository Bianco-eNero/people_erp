...
<section class="employees">
    <header class="header">
        <nav class="sections">
            ...
            <a href="<?php echo $server; ?>application/human_resource/" >
                <h1 style="width: 127px;height: 100%;"><?php echo $vHumanResource; ?></h1>
            </a>
            <ul>
				<?php
                                ...
                                <div role="content" style="font-weight: 100;">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <ul class="bs-glyphicons" style="padding: 10px;margin: 0">
                                            <li>
                                                <a href="contract_group/?case_id=5&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vContractCategory;?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="contract_type/?case_id=4&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vContractType?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="countries/?case_id=3&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vCountry?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="end_service_type/?case_id=82&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vEndServiceType?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="experience_types/?case_id=83&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vExperienceTypes?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="military_service/?case_id=24&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vMilitaryStatus?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="penalty_type/?case_id=86&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vPenaltyType?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="relation_type/?case_id=85&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vRelationType?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="training_types/?case_id=84&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vTrainingTypes?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="educ_university/?case_id=28&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vSchoolAndCollege?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="driving_lic_type/?case_id=87&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vDrivingLicType?></span>
                                                </a>
                                            </li>
                                            <li style="display: none">
                                                <a href="gender/?case_id=88&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vGender?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="social_status/?case_id=89&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vSocialStatusTypes?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="job_status/?case_id=90&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vJobStatus?></span>
                                                </a>
                                            </li>
                                        </ul>
