		...
		<section class="employees">
			<header class="header dont_print_me">
				<nav class="sections">
					...
					<!-- EDIT HERE 1 -->
					<a href="<?php echo $server; ?>application/human_resource/human_resource/" >
				...
				<section class="control dont_print_me">
					<section class="action">
						<h1><span class="root"><?php
							...
							<fieldset>
								<a class="focus" href="../../settings/experience_types/?add_now=1&case_id=<?php echo $_GET['case_id']; ?>&case_filter=<?php echo $_GET['case_filter']; ?>&ref=" style="text-decoration:none;"><input type="submit" name="create" id="create" value="<?php echo $vAdd; ?>" class="focus" /></a>
					...
					<section class="employee-create">
						...
						<section class="title">
							...
							<fieldset>
							  ...
							  <input value="<?php if($_GET['edit_now']=='1' || $_GET['duplicate_now']=='1' || $_GET['view_now']=='1') { if($_SESSION['language']=='AR') { echo $row_curr[$row_add_2['table_field_ar']]; } else { echo $row_curr[$row_add_2['table_field_en']]; } } ?>"  style="display: none" name="<?php echo $row_add_2['field_name']; ?>" type="text" id="part-time" placeholder="<?php
								if($_SESSION['language']=='AR')
								{
