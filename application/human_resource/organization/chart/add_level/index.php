...
if(isset($_POST['org_vert_level']))
{

$aaaddd=$_POST['org_vert_level'];
...
$org_vert_level=$_POST['org_vert_level'];
				...
				<article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable" style="margin: 10px">
							...
							<div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
								...
								<header role="heading" style="background-color: #865b7a; color: white"><div class="jarviswidget-ctrls" role="menu" > </div>
									...
									<h2 class="droid-arabic-kufi"><?php echo $vAddLevel; ?> </h2>
											...
											<fieldset>
												...
												<section>
													...
													<label class="input">
														...
														<select style="width:100%" class="select2 select2-hidden-accessible droid-arabic-kufi col-md-6" tabindex="-1" aria-hidden="true" name="org_vert_level">

												<?php

	$cat_id=$_GET['cat_id'];

$query_Recordset_skill = "SELECT * FROM a_job_degree ORDER BY 	j_d_id_p";
...
$totalRows_Recordset_skill = mysqli_num_rows($Recordset_skill);
						...
						?>
														...
														<option style="font-weight: 100" class="droid-arabic-kufi" value="<?php echo $row_Recordset_skill['j_d_id']; ?>">&nbsp; &nbsp; <?php echo $row_Recordset_skill['j_d_name']; ?></option>
