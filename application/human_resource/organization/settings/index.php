                                ...
                                <div role="content" style="font-weight: 100;">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <ul class="bs-glyphicons" style="padding: 10px;margin: 0">
                                            <li>
                                                <a href="job_groups/?case_id=15&case_filter=&ref=">
                                                    <i class="fas fa-folder-open fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vJobGroups?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="job_category/?case_id=81&case_filter=&ref=">
                                                    <i class="fas fa-folder fa-fw fa-5x"></i>
                                                    <span class="glyphicon-class"><?php echo $vSelectJobCat?></span>
                                                </a>
                                            </li>
                                        </ul>
