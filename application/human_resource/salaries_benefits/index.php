                                            ...
                                            <div class="row mbr-justify-content-center">
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        ...
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="earnings/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vEarnings; ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        ...
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="deduction/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vDeduction; ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        <div class="ico-wrap">
                                                            <span style="color:white" class="mbr-iconfont fa-plus fa"></span>
                                                        </div>
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="benefits/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo str_replace('ال', '', $vBenefits); ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        <div class="ico-wrap">
                                                            <span style="color:white" class="mbr-iconfont fa-file-alt fa"></span>
                                                        </div>
                                                        <div class="text-wrap vcenter">
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        <div class="ico-wrap">
                                                            <span style="color:white" class="mbr-iconfont fa-info fas"></span>
                                                        </div>
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="inquiry/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vInquiry ; ?> </span></a></h1>
