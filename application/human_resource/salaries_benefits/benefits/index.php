			...
			<main class="main" style="height:100%">
				<section class="control">
					<section class="action">
						<h1><?php echo  str_replace('ال', '', $vBenefits); ?></h1>
										...
										<div class="container">
                                            ...
                                            <div class="row mbr-justify-content-center">
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        ...
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="job_regulation/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vJobRegulation; ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        <div class="ico-wrap">
                                                            <span style="color:white" class="mbr-iconfont fa-exchange-alt fas"></span>
                                                        </div>
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="best_performance_increase/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vBestPerformanceIncrease; ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        <div class="ico-wrap">
                                                            <span style="color:white" class="mbr-iconfont fa-award fas"></span>
                                                        </div>
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="best_performance_increase_formula/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vBestPerformanceIncreaseFormula; ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mbr-col-md-6">
                                                    <div class="wrap">
                                                        <div class="ico-wrap">
                                                            <span style="color:white" class="mbr-iconfont fa-calculator fa"></span>
                                                        </div>
                                                        <div class="text-wrap vcenter">
                                                            <h1 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <a href="best_performance_calculation/" style="color:white"><span class="arabic" style="font-size:20px"><?php echo $vBestPerformanceCalculation; ?> </span></a></h1>
                                                        </div>
                                                    </div>
                                                </div>
