		...
		<section class="employees">
			<header class="header">
				<nav class="sections">
					...
					<a href="<?php echo $server; ?>application/human_resource/time_control/" >
						<h1 style="height: 100%;"><?php echo str_replace('ال', '', $vTime); ?></h1>
					</a>
						<ul>
							<?php
							//// include training header ////
							include('../../../assets/menus/header/time_control.php')
							?>
						</ul>
				</nav>
